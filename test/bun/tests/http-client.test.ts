/**
 * Bun Test Suite for HttpClient
 * Black-box tests covering all functionality
 *
 * Prerequisites: Mock server must be running on port 3003
 * Start with: bun ../mock-server/server.ts --port=3003
 */
...
describe('HttpClient - Basic Requests (Bun)', () => {
...
describe('HttpClient - Streaming (Bun)', () => {
...
describe('HttpClient - Interceptors (Bun)', () => {
...
describe('HttpClient - Error Handling (Bun)', () => {
...
describe('HttpClient - Progress Tracking (Bun)', () => {
...
describe('HttpClient - Edge Cases (Bun)', () => {
